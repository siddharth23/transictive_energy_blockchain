...
app.get_role(function(error,response){
console.log(response);
if(response==="consumer"){
$("#set").attr('disabled');
$("#role").html("Hello Consumer!! Enter your demand below");
}
else{if(response=="producer"){
$("#set").attr('disabled');
$("#role").html("Hello Producer!! Enter your supply");
}
else{
$("#role").html("<p style='color:red'>Please ask account owner to add you as Consumer or Producer for contributing</p>");
